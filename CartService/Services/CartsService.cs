...
using Microsoft.EntityFrameworkCore; // Ajout pour l'accès à la base de données
...
namespace CartService.Services
{
    public class CartsService : ICartService
    {
        ...
        private readonly ProductDbContext _dbContext; // Contexte pour accéder à la table Products
        ...
        public async Task<Cart> GetCart(int userId)
        {
            ...
            // Retourner le panier avec le total calculé
            return new Cart
            {
                UserId = userId,
                Items = cartItems,
                TotalAmount = totalAmount // Remplir avec le total calculé
            };
        }
